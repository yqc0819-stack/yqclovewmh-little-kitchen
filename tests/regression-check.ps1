...
Assert-Contains "聊天" "表情选择面板" $html 'id="emoji-picker"'
Assert-Contains "聊天" "常用小表情" $app 'const chatEmojis'
Assert-Contains "聊天" "消息撤回入口" $app 'data-recall-id'
Assert-Contains "聊天" "云端撤回逻辑" $cloud 'async function recallMessage'
